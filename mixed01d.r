...
str(SS_2011)
table(SS_2011)
rdf=mcas('3',"2011","MTH",thetas$theta4)
ori=rdf[rdf[,1]==0]    #scaled score has item number in column 1 = 0
SS_2012=ori[2:length(ori)]  
str(SS_2012)
table(SS_2012)
MCAS_wide=data.frame(IDcol,GRADE_2009,GRADE_2010,GRADE_2011,GRADE_2012,SS_2009,SS_2010,SS_2011,SS_2012)
colnames(MCAS_wide)=c("ID","GRADE_2009","GRADE_2010","GRADE_2011","GRADE_2012","SS_2009","SS_2010","SS_2011","SS_2012")
str(MCAS_wide)
summary(MCAS_wide)
library(SGP)
